# C.A.R.E.B.A 🌊
**Canal Alert & Real-time Early-warning Broadcast Apparatus**

An IoT-based Smart City solution designed for real-time drainage monitoring and advocating for government infrastructure funding (Musrenbang).
...
- **Telegram Bot Integration:** Acts as an early-warning system to alert residents to potential canal overflow and asset endangerment.
